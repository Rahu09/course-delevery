  ...
  return (
    <div>
      <div className="landing-intro">
        ...
        <p>
          and have an inclusive community focusing on a learn by doing approach.
        </p>
      ...
      <div className="about-us gradient">
        <div>
          <img
            src="https://wemakedevs.org/static/media/aboutus.02f2915b9ae736e9ef8a.png"
            alt=""
          />
        </div>
        <div>
          ...
          <ul>
            <li>
              ...
              technical or non-technical background can make it big. WeMakeDevs
