...
function UpdateCourse() {
  ...
  return (
    <div id="update--container" className="gradient">
      <GrayTopper />
      ...
      <div>
        {showCreate && (
          <div className="update--content">
            ...
            {addText && <Textarea setText={setText} />}
            <Button
              size={"large"}
              variant="contained"
              style={{ width: "40%", background: "black", margin: 10 }}
            ...
            {link !== "nil" && <YoutubeEmbed embedId={link} />}
            {(addText || addVideo) && (
              <Button
                size={"large"}
                variant="contained"
    ...
    <>
      <Editor
        ...
        init={{
          ...
          toolbar:
            "formatselect" +
            "|fontselect fontsizeselect formatselect | undo redo | bold italic underline strikethrough | alignleft aligncenter alignright alignjustify | outdent indent |  numlist bullist | forecolor backcolor removeformat | pagebreak | charmap emoticons | fullscreen  preview save print | insertfile image media template link anchor codesample | ltr rtl",
          toolbar_sticky: true,
...
function UpdateCard() {
  ...
  return (
    <div style={{ display: "flex", justifyContent: "center" }}>
      <Card
        varint={"outlined"}
        style={{ maxWidth: 700, marginTop: "35vh" }}
          ...
          <Button
            ...
            onClick={async () => {
              axios.put(
                ...
                `${baseUrl}/courses/` + courseDetails.course._id,
                {
                  title: title,
                  description: description,
                  imageLink: image,
